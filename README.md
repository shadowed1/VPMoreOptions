...
_- Spawn menu enabled for Arena and Siege.
...
- Enemy AI have slightly reduced melee range._

**How to Install**:

_- Requires Melonloader 0.7.1.
...
- Place VPMoreOptions.dll in the Mods folder and run the game. _

**Known Issues:**

_- Spawn Menu appears twice in Arena and Siege, but it doesn't harm anything._
